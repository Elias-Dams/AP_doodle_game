...
View::Jetpack::Jetpack(Entity_Model &subject, float Width, float Height, shared_ptr<Camera> camera_) : Bonus(subject), camera(camera_), jetpack_Width(Width), jetpack_Height(Height){
