...
View::Player::Player(Entity_Model &subject, float playerWidth_ , float playerHeight_ , shared_ptr<Camera> camera_) : Entity_View(subject), camera(camera_), playerWidth(playerWidth_), playerHeight(playerHeight_){
