...
bool World::colisionCheck(shared_ptr<Entity_Model> entity){
    ...
    if(entity->getPosition().first <= player->getPosition().first and player->getPosition().first <= entity->getPosition().first+entity->getWidth()){

        if(player->getPosition().second - (entity->getPosition().second + entity->getHeight()) <= 0 and player->getPosition().second - entity->getPosition().second >= 0 and player->isfalling()){

            return true;
        }
    }
    // right side of the player
    else if(entity->getPosition().first <= player->getPosition().first+player->getWidth() and player->getPosition().first+player->getWidth() <= entity->getPosition().first+entity->getWidth()){
    ...
    // between the player
    else if(entity->getPosition().first >= player->getPosition().first and player->getPosition().first+player->getWidth() >= entity->getPosition().first+entity->getWidth()){
